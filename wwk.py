...
\033[1;91m   ╔═══════════════════════════════════════════╗
\033[1;93m   |                                           |
\033[1;92m   |Author:  HAMZU SARKAR         |
\033[1;93m   |                                           |
\033[1;93m   |Github:  https://github.com/HamzuSarkar|
\033[1;93m   |                                           |
\033[1;93m   |Facebook: Hamzu Sarkar           |
\033[1;93m   |                                           |
\033[1;93m   ╚═══════════════════════════════════════════╝    
...
\033[1;91m    ███ ███   ███ ███  ██   ██ 
            
"""
CorrectCodeWord = 'wwkbrand'
print '   \x1b[1;93m[🔒🔒🔒] CodeWord Required To Enter [🔒🔒🔒]'
loop = 'true'
while loop == 'true':
    CodeWord = raw_input('\x1b[1;93m[\x1b[1;92m@WWK@\033[1;93m] \x1b[1;91m[🔐] Enter CodeWord\x1b[1;97m: ')
    if (CodeWord == CorrectCodeWord):
        print('\n            \x1b[1;92m🔓🔓🔓 Correct Entry 🔓🔓🔓 \n                  ')
        jalan('    \x1b[1;97m•◈•◈•◈•◈• Welcome To WWK Tool •◈•◈•◈•◈•')
        loop = 'false'
    else:
        print '\x1b[1;91mWrong Entry!'
        os.system('xdg-open https://facebook.com/hamzusarkar
...
def own():
    ...
    p.map(main, id)
    print 50 * '\x1b[1;95m'
    print '\x1b[1;95m◈◈◈◈◈◈◈◈◈◈◈ Developed By Hamzu Sarkar ◈◈◈◈◈◈◈◈◈◈◈ '
    print '[✅] Process Has Been Completed ...'
    print '[✅] Total Active/In-Active : ' + str(len(oks)) + '/' + str(len(cpb))
    print '[✅] Cloned Accounts Has Been Saved : cloned/idz.txt'
    jalan('\x1b[1;96mInstruction:')
